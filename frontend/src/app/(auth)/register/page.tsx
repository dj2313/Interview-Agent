    ...
    <main className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-sm mx-auto px-6">
        ...
        <div className="glass rounded-2xl p-8 border border-white/5">
          ...
          <p className="text-muted-foreground text-sm mb-6">Start your interview preparation journey</p>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-sm font-medium mb-1 block">Full name (optional)</label>
